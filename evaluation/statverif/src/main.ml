...
let show_version () =
  Printf.printf "StatVerif 1.97pl1.1. Cryptographic protocol verifier by Eike Ritter and Mark Ryan. Based on ProVerif\n";
  exit 0
...
let _ =
  Arg.parse
    ...
    anal_file "StatVerif 1.97pl1.1. Cryptographic protocol verifier by Eike Ritter and Mark Ryan. Based on ProVerif";
