...
.L162:
	...
	movq	$13, %rcx
	movq	$1, %rdx
	movq	camlQuicksort__string_324@GOTPCREL(%rip), %rsi
...
.L170:
	movq	$5, %rcx
	movq	$1, %rdx
	movq	camlQuicksort__string_402@GOTPCREL(%rip), %rsi
	movq	camlPervasives__Pccall_1634@GOTPCREL(%rip), %rax
	movq	(%rax), %rdi
	.loc	2	349	2
	movq	caml_ml_output@GOTPCREL(%rip), %rax
...
.L209:
	...
	jne	.L213
.L212:
	movq	camlPervasives__exit_function_1594@GOTPCREL(%rip), %rax
	movq	(%rax), %rax
	.loc	2	538	20
	movq	(%rax), %rbx
	movq	$1, %rax
...
.L210:
	movq	$1, %rdi
	.loc	2	542	2
	movq	caml_sys_exit@GOTPCREL(%rip), %rax
	call	caml_c_call@PLT
.L211:
	movq	caml_young_ptr@GOTPCREL(%rip), %r11
	movq	(%r11), %r15
...
.L247:
	...
	.align	8
.L239:
	.long	(.L271 - .) + -2080374784
	.long	254400
	.quad	0
	.align	8
.L220:
	.long	(.L271 - .) + 1744830464
	.long	319552
	.quad	.L221
	.align	8
.L230:
...
.L262:
	...
	.align	8
.L245:
	.long	(.L271 - .) + 1677721600
	.long	294976
	.quad	0
	.align	8
.L229:
	.long	(.L272 - .) + -1409286144
	.long	1913168
	.quad	.L230
	.align	8
.L216:
	.long	(.L272 - .) + 1207959552
	.long	2220064
	.quad	.L217
	.align	8
.L246:
	.long	(.L271 - .) + 1543503872
	.long	245792
	.quad	0
	.align	8
.L267:
...
.L253:
	...
	.align	8
.L236:
	.long	(.L271 - .) + 1073741824
	.long	262288
	.quad	0
	.align	8
.L228:
	.long	(.L272 - .) + -1140850688
	.long	1429536
	.quad	.L229
	.align	8
.L224:
...
.L221:
	...
	.align	8
.L250:
	.long	(.L271 - .) + 1811939328
	.long	225440
	.quad	0
	.align	8
.L218:
	.long	(.L272 - .) + -1677721600
	.long	2203968
	.quad	.L219
	.align	8
.L251:
